...
function updateLanguage() {
  ...
  if (exportBtn) {
    exportBtn.textContent = exportBtn.disabled ? t("msg_exporting") : t("btn_export");
  }
...
async function exportWorkbook(){
  ...
  if(btn){ btn.disabled = true; btn.textContent = t("msg_exporting"); }
  try{
    ...
    if(btn){ btn.disabled = false; btn.textContent = t("btn_export"); }
  }
}
